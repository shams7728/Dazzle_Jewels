    ...
    return (
        <section className="relative h-screen w-full overflow-hidden bg-black">
            ...
            <div className="relative z-20 flex h-full flex-col items-center justify-center text-center px-4">
                ...
                >
                    <h2 className="mb-4 text-sm font-medium tracking-[0.2em] text-yellow-500 uppercase">
                        New Collection 2025
                    </h2>
                </motion.div>
                ...
                >
                    <h1 className="mb-6 text-5xl font-bold tracking-tight text-white sm:text-7xl md:text-8xl">
                        TIMELESS <br /> <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-200 via-yellow-500 to-yellow-200">ELEGANCE</span>
                    </h1>
                </motion.div>
                ...
                >
                    <Link href="/products">
                        <Button size="lg" className="bg-yellow-500 text-black hover:bg-yellow-400 px-8 py-6 text-lg rounded-full">
