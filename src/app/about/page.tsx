...
export default function AboutPage() {
    return (
        <main className="min-h-screen bg-black text-white overflow-hidden">
                    ...
                    <div className="max-w-4xl">
                        ...
                        >
                            ...
                            <h1 className="text-5xl sm:text-6xl md:text-8xl font-bold text-white mb-6">
                                ...
                                <span className="inline-block bg-gradient-to-r from-yellow-500 via-yellow-300 to-yellow-500 bg-clip-text text-transparent animate-shimmer">
                                    Story
                                </span>
                            </h1>
                            ...
                            <motion.p
                                ...
                                className="text-xl sm:text-2xl md:text-3xl text-neutral-300 mb-8"
                            >
                            ...
                            >
                                <motion.button
                                    ...
                                    whileTap={{ scale: 0.95 }}
                                    className="px-8 py-3 bg-yellow-500 text-black font-semibold rounded-full hover:bg-yellow-400 transition-colors"
                                >
                                    Explore Collection
                                </motion.button>
                                <motion.button
                                    whileHover={{ scale: 1.05 }}
                                    whileTap={{ scale: 0.95 }}
                                    className="px-8 py-3 border-2 border-yellow-500 text-yellow-500 font-semibold rounded-full hover:bg-yellow-500/10 transition-colors"
                                >
                                    Contact Us
                                </motion.button>
                            </motion.div>
            ...
            {/* Stats Section */}
            <section className="py-20 bg-gradient-to-b from-black to-neutral-900/50">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                        {stats.map((stat, index) => (
                            <ScrollReveal key={index} delay={index * 0.1}>
                                <motion.div
                                    whileHover={{ scale: 1.05 }}
                                    className="text-center p-6 rounded-2xl bg-neutral-900/50 border border-neutral-800 hover:border-yellow-500/50 transition-all"
                                >
                                    <motion.div
                                        initial={{ scale: 0 }}
                                        whileInView={{ scale: 1 }}
                                        ...
                                        viewport={{ once: true }}
                                    >
                                        <h3 className="text-4xl md:text-5xl font-bold text-yellow-500 mb-2">
                                            {stat.value}
                                        </h3>
                    ...
                    <ScrollReveal>
                        <div className="space-y-6">
                            ...
                            <h2 className="text-4xl md:text-5xl font-bold">
                                The <span className="text-yellow-500">Dazzle</span> Difference
                            </h2>
            ...
            {/* Values Section */}
            <section className="bg-gradient-to-b from-neutral-900/50 to-black py-20 md:py-32">
                <div className="container mx-auto px-4">
                    <ScrollReveal>
                    ...
                    <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                        {values.map((value, index) => (
                            <ScrollReveal key={index} delay={index * 0.1}>
                                <motion.div
                                    whileHover={{ y: -8 }}
                                    className="group relative p-8 rounded-2xl border border-neutral-800 bg-black/50 hover:border-yellow-500/50 transition-all duration-300 overflow-hidden"
                                >
                                    ...
                                    <div className="relative z-10">
                                        <motion.div
                                            ...
                                            className="h-16 w-16 rounded-2xl bg-yellow-500/10 flex items-center justify-center mb-6 group-hover:bg-yellow-500/20 transition-colors"
                                        >
                        ...
                        <ScrollReveal key={index} delay={index * 0.1}>
                            ...
                            >
                                ...
                                <motion.div
                                    ...
                                    className="absolute left-0 top-0 w-4 h-4 bg-yellow-500 rounded-full -translate-x-[9px] group-hover:shadow-lg group-hover:shadow-yellow-500/50 transition-shadow"
                                />
                                
                                {/* Year badge */}
                                <div className="absolute left-0 md:left-8 top-0 md:-translate-x-full md:pr-8">
                                    <span className="inline-block px-4 py-1 bg-yellow-500/10 border border-yellow-500/30 rounded-full text-yellow-500 font-semibold text-sm">
                                        {item.year}
                                    </span>
                                </div>
            ...
            <section className="relative py-20 md:py-32 overflow-hidden">
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <ScrollReveal>
                        <motion.div
                            whileHover={{ scale: 1.02 }}
                            className="max-w-4xl mx-auto text-center p-12 md:p-16 rounded-3xl border border-yellow-500/30 bg-black/50 backdrop-blur-sm"
                        >
                            ...
                            <div className="flex flex-wrap gap-4 justify-center">
                                <motion.button
                                    whileHover={{ scale: 1.05 }}
                                    whileTap={{ scale: 0.95 }}
                                    className="px-8 py-4 bg-yellow-500 text-black font-semibold rounded-full hover:bg-yellow-400 transition-colors shadow-lg shadow-yellow-500/20"
                                >
                                    Shop Now
                                </motion.button>
                                <motion.button
                                    whileHover={{ scale: 1.05 }}
                                    whileTap={{ scale: 0.95 }}
                                    className="px-8 py-4 border-2 border-yellow-500 text-yellow-500 font-semibold rounded-full hover:bg-yellow-500/10 transition-colors"
                                >
                                    Book Consultation
                                </motion.button>
                            </div>
